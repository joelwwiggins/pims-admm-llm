...
def test_permission_architecture_hard_false_with_structural_trues():
    assert tlb.case1_form_label_ship_allowed_today() is False
    assert (
    ...
    assert met_ws["form_label_change_shipped"] is False
    met_gate = tlb.case1_online_linf_gate_criteria_met_today_map()
    assert met_gate["form_label_change_shipped"] is False
    met_pp = tlb.case1_dual_honest_tf_aware_path_present_criteria_met_today_map()
    assert met_pp["form_label_change_shipped"] is False
    assert report["wire_ship_criterion_form_label_change_shipped_met_today"] is False
...
def test_form_contract_and_ladder_non_regression():
    ...
    assert ship_met["criteria_met_today_map"]["form_label_change_shipped"] is False

...
def honesty_metadata() -> Dict[str, Any]:
    ...
    return {
        ...
        "admm_case1_wire_fifth_coreq_operational_prep_available": True,
...
def offline_block_solve_readiness_report(
    *,
    ...
    include_admm_case1_wire_fifth_coreq_operational_prep: bool = True,
    include_admm_case1_isolation_rewrite_first_blocker_execution_scaffold: bool = True,
) -> Dict[str, Any]:
    ...
    ``admm_case1_dual_linf_fourth_coreq_operational_prep_ok``, and
    ``admm_case1_wire_fifth_coreq_operational_prep_ok`` are
    **additive** pre-wire checklist info (does **not** change
    ...
    admm_case1_form_label_second_coreq_operational_prep_ok: Optional[bool] = None
    if include_admm_case1_form_label_second_coreq_operational_prep:
        try:
            # Additive readiness: form_label second-coreq operational prep
            # (prep_present; form classic; form_label_change_shipped hard False;
            # dual_recovery_path=None; not VERDICT; not form flip).
            fl_prep_rep = (
                offline_case1_form_label_second_coreq_operational_prep_report()
            )
            admm_case1_form_label_second_coreq_operational_prep_ok = bool(
                fl_prep_rep.get(
                    "prep_ok",
                    fl_prep_rep.get("contract_ok", fl_prep_rep.get("ok")),
                )
            )
        except Exception:  # pragma: no cover - defensive
            admm_case1_form_label_second_coreq_operational_prep_ok = False
    base["admm_case1_form_label_second_coreq_operational_prep_ok"] = (
        admm_case1_form_label_second_coreq_operational_prep_ok
    )

    admm_case1_path_third_coreq_operational_prep_ok: Optional[bool] = None
    if include_admm_case1_path_third_coreq_operational_prep:
        try:
            # Additive readiness: path third-coreq operational prep
            # (prep_present; path_shipped hard False; dual_honest_tf_aware_path_present
            # ship-met False; dual_recovery_path=None; not VERDICT; not path ship).
            path_prep_rep = (
                offline_case1_path_third_coreq_operational_prep_report()
            )
            admm_case1_path_third_coreq_operational_prep_ok = bool(
                path_prep_rep.get(
                    "prep_ok",
                    path_prep_rep.get("contract_ok", path_prep_rep.get("ok")),
                )
            )
        except Exception:  # pragma: no cover - defensive
            admm_case1_path_third_coreq_operational_prep_ok = False
    ...
    admm_case1_wire_fifth_coreq_operational_prep_ok: Optional[bool] = None
    if include_admm_case1_wire_fifth_coreq_operational_prep:
        try:
            # Additive readiness: wire fifth-coreq operational prep
            # (prep_present; wire_shipped hard False; wire_ship_allowed False;
            # dual_recovery_path=None; not VERDICT; not wire ship).
            wire_prep_rep = (
                offline_case1_wire_fifth_coreq_operational_prep_report()
            )
            admm_case1_wire_fifth_coreq_operational_prep_ok = bool(
                wire_prep_rep.get(
                    "prep_ok",
                    wire_prep_rep.get("contract_ok", wire_prep_rep.get("ok")),
                )
            )
        except Exception:  # pragma: no cover - defensive
            admm_case1_wire_fifth_coreq_operational_prep_ok = False
    base["admm_case1_wire_fifth_coreq_operational_prep_ok"] = (
        admm_case1_wire_fifth_coreq_operational_prep_ok
    )

    admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok: Optional[bool] = None
    if include_admm_case1_isolation_rewrite_first_blocker_execution_scaffold:
        try:
            # Additive readiness: isolation first-blocker rewrite *execution scaffold*
            # (scaffold_present; isolation_rewrite_shipped hard False;
            # isolation_ship_allowed False; dual_recovery_path=None; not VERDICT).
            iso_scaf_rep = (
                offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report()
            )
            admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok = bool(
                iso_scaf_rep.get(
                    "scaffold_ok",
                    iso_scaf_rep.get("contract_ok", iso_scaf_rep.get("ok")),
                )
            )
        except Exception:  # pragma: no cover - defensive
            admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok = False
    base["admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok"] = (
        admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok
    )
    base["note"] = (
...
def offline_wire_preflight_report(
    *,
    ...
    readiness = offline_block_solve_readiness_report(
        ...
        include_admm_case1_form_label_second_coreq_operational_prep=(
            include_admm_case1_form_label_second_coreq_operational_prep
        ),
        ...
        include_admm_case1_wire_fifth_coreq_operational_prep=(
            include_admm_case1_wire_fifth_coreq_operational_prep
        ),
        include_admm_case1_isolation_rewrite_first_blocker_execution_scaffold=(
            include_admm_case1_isolation_rewrite_first_blocker_execution_scaffold
        ),
    )
    ...
    admm_case1_form_label_second_coreq_operational_prep_ok = readiness.get(
        "admm_case1_form_label_second_coreq_operational_prep_ok"
    )
    ...
    admm_case1_wire_fifth_coreq_operational_prep_ok = readiness.get(
        "admm_case1_wire_fifth_coreq_operational_prep_ok"
    )
    admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok = readiness.get(
        "admm_case1_isolation_rewrite_first_blocker_execution_scaffold_ok"
    )
    ...
    order_rows: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "prep_note": (
                ...
                "form_label_change_shipped still False; operational prep present ≠ form ship."
            ),
        },
        {
            "order_index": 2,
            ...
            "prep_artifacts": [
                ...
                "offline_case1_dual_honest_tf_aware_path_execution_scaffold_report (scaffold_present; inventory only; not path ship)",
                "offline_case1_path_third_coreq_operational_prep_report (prep_present; path_shipped false; dual_honest_tf_aware_path_present ship-met false; third coreq; not first_blocking)",
            ],
            "test_surface": (
                "tests/test_tf_offline_case1_path_third_coreq_operational_prep.py"
            ),
            "prep_note": (
                "Path design+criteria+scaffold present; operational prep present ≠ path ship ≠ "
                "path present ship-met; path_shipped=False; dual_honest_tf_aware_path_present "
                "ship-met=False; feature flag reserved false; scaffold inventory ≠ path ship."
            ),
        },
        {
            "order_index": 3,
        ...
        },
        {
            ...
            "prep_artifacts": [
                ...
                "offline_case1_wire_fifth_coreq_operational_prep_report (prep_present; wire_shipped false; wire_ship_allowed false; fifth coreq; not first_blocking)",
            ],
            "test_surface": (
                "tests/test_tf_offline_case1_wire_fifth_coreq_operational_prep.py"
            ),
            "prep_note": (
                "Wire-ship acceptance design present; operational prep present ≠ wire "
                "shipped ≠ wire allow ≠ dual_linf proven ≠ design alone ≠ preflight "
                "alone; wire_shipped=False; wire_ship_allowed_today=False; fifth coreq "
                "not first_blocking."
            ),
        },
    ]
...
# ---------------------------------------------------------------------------
# Offline Case-1 form_label second-coreq *operational prep* (goal 5+3 honesty)
# ---------------------------------------------------------------------------
# Always-on pure compose. Formalizes *how form second-coreq prep lands without
# ship* for order_hint[1] form_label_change_shipped. Distinct from form_label
# ship criteria contract (that formalizes *when shipped*). Pattern mirror of
# isolation first-blocker operational prep (#67). Hard: form remains
# classic_2block_excel_path; form_label_change_shipped=False;
# form_label_ship_allowed_today=False; criteria_met_today=False (do not claim
# form ship criteria met via prep); form_mutation_path_executed_today=False;
# first_blocking_coreq remains isolation_rewrite_with_wire (form is second);
# dual_recovery_path=None; dual_linf unproven; ship flags hard false.
# Does NOT clear DEFAULT_WIRE_BLOCKERS. Does NOT redefine ready_for_wire_discussion.
# No TF / no PuLP / no excel_pipeline.

CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_KIND = (
    "offline_case1_form_label_second_coreq_operational_prep"
)
CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANNOTATION = "present"
CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_INDEX = 1
CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_COREQ = "form_label_change_shipped"

CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY: tuple = (
    "this_prep_alone",
    "form_label_criteria_alone",
...
CASE1_FORM_LABEL_SECOND_COREQ_COMPANION_ARTIFACTS: Dict[str, Any] = {
    "companion_artifacts_are_inventory_only": True,
    "form_registration_constants": [
        "CASE1_FORM_CURRENT",
    ...
    "dual_space_form_contract": "offline_case1_dual_space_form_contract_report",
    "mutation_path_name": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME,
    "mutation_path_executed_today": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_EXECUTED_TODAY,
}


def case1_form_label_second_coreq_companion_artifacts() -> Dict[str, Any]:
    """Static companion artifact inventory (inventory only — not form flip)."""
    return {
        "companion_artifacts_are_inventory_only": True,
        "form_registration_constants": list(
            CASE1_FORM_LABEL_SECOND_COREQ_COMPANION_ARTIFACTS[
                "form_registration_constants"
            ]
        ),
        "form_label_ship_criteria_report": (
        ...
        "dual_space_form_contract": (
            CASE1_FORM_LABEL_SECOND_COREQ_COMPANION_ARTIFACTS[
                "dual_space_form_contract"
            ]
        ),
        "mutation_path_name": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME,
        "form_mutation_path_name": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME,
        "form_mutation_path_executed_today": (
            CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_EXECUTED_TODAY
        ),
        "note": (
            "Inventory of form second-coreq companion artifacts. Registration + "
            "form_label ship criteria + dual-space form contract are listed only — "
            "not re-executed; mutation path named not executed. Prep inventory ≠ "
            "form_label_change_shipped."
        ),
    }


def case1_form_label_second_coreq_prep_steps() -> List[Dict[str, Any]]:
    """Machine-readable prep steps for form second-coreq (no form flip)."""
    dual_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    return [
        {
            "step_id": "form_registration_present",
            "artifact": "CASE1_FORM_CURRENT / CASE1_PLANNED_TF_AWARE_FORM",
            "status": "present",
            "executes_form_flip": False,
            "ships": False,
            "note": "Form registration formalizes *what*; form remains classic.",
        },
        {
            "step_id": "form_ship_criteria_present",
            "artifact": (
                "offline_case1_form_label_change_shipped_criteria_contract_report"
            ),
            "status": "present_ship_false",
            ...
            "ships": False,
            "note": (
                "Form ship criteria formalize *when*; form_label_change_shipped "
                "still False; criteria_met_today False."
            ),
        },
        {
            "step_id": "mutation_path_named_not_executed",
            "artifact": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME,
            "status": "named_not_executed",
            "executes_form_flip": False,
            "ships": False,
            "note": (
                "Mutation path named for future wire; "
                f"executed_today="
                f"{CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_EXECUTED_TODAY}."
            ),
        },
        {
            "step_id": "dual_space_form_companion_inventory",
            "artifact": "offline_case1_dual_space_form_contract_report",
            "status": "inventory_only",
            "executes_form_flip": False,
            "ships": False,
            "note": "Dual-space form contract companion inventory only.",
        },
        {
            "step_id": "dual_ban_locks",
            "artifact": "prep_dual_ban_tokens",
            ...
            "ships": False,
            "note": (
                "prep≠ship; form classic; dual_linf unproven; dual_recovery_path=None "
                f"today; planned under wire={dual_planned} (not pure-ADMM); "
                "first_blocking still isolation."
            ),
        },
        {
            ...
            "ships": False,
            "note": (
                "order_hint_index=1 form_label_change_shipped is second coreq; "
        ...
        },
        {
            ...
            "ships": False,
            "note": (
                "Prep steps complete ≠ form_label_change_shipped ≠ form flip ≠ "
                "wire ≠ VERDICT."
            ),
        },
    ]
...
def _case1_form_label_second_coreq_operational_prep_honesty_fields() -> Dict[str, Any]:
    """Machine-readable dual-ban / prep-is-not-ship locks for form second coreq."""
    return {
        "kind": CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_KIND,
        "solver": False,
        "dual_recovery_path": None,
        "on_excel_case1_path": False,
        "on_case1_solve": False,
        ...
        "this_prep_alone_is_anti_criterion_for_form_ship": True,
        "go_board_alone_is_not_ship_criterion": True,
        "design_alone_is_not_ship_criterion": True,
        "ship_criteria_alone_is_not_ship_criterion": True,
        "blueprint_alone_is_not_ship_criterion": True,
        ...
        "order_hint_index": CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_INDEX,
        "order_hint_coreq": CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_COREQ,
        ...
        "no_blender_offline_affine_kernel_blocker_still_true": True,
        "case1_is_cdu_blender_package_admm_blocker_still_true": True,
        "scope": "case1_form_label_second_coreq_operational_prep_offline",
        "note": (
            "Offline Case-1 form_label second-coreq *operational prep*: machine-readable "
            "*how prep lands without ship* for order_hint[1] form_label_change_shipped. "
            "prep_present=True / form_label_second_coreq_prep_present=True; "
            "form remains classic_2block_excel_path; form_label_change_shipped=False; "
            "form_label_ship_allowed_today=False; criteria_met_today=False (does not claim "
            "form ship criteria met); form_mutation_path_executed_today=False with path "
            f"named {CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME}; path/wire/bundle/"
            "isolation ship flags hard false; dual_linf unproven; dual_recovery_path=None "
            f"today; planned under wire={CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED} "
            "(not pure-ADMM); first_blocking_coreq remains isolation_rewrite_with_wire "
            "(form is second, not first). Distinct from form_label ship criteria contract "
            "(*when shipped*). Prep alone / form criteria alone / dual_space_form alone / "
            "packaging alone / blueprint alone / scaffold alone / rehearsal alone / path "
            "design alone / diagnostic L∞ ≠ form_label_change_shipped ≠ form flip ≠ wire ≠ "
            "VERDICT. Does not redefine ready_for_wire_discussion; does not clear "
            "DEFAULT_WIRE_BLOCKERS; does not enable Case 1 TF feature flag; isolation suite "
            "behavior unchanged. SUGGESTED_NEXT_WAVE still full multi-blocker wire "
            "*execution* long-term."
        ),
    }


def offline_case1_form_label_second_coreq_operational_prep_report() -> Dict[str, Any]:
    """Always-on form_label second-coreq operational prep (prep without ship).

    No TF, no PuLP, no excel_pipeline, no Case 1 solve routing. Aggregate
    ``ok`` / ``contract_ok`` / ``prep_ok`` = prep formalized ∧ honesty locks ∧
    prep_present ∧ first_blocking_coreq=isolation_rewrite_with_wire ∧ form
    classic ∧ form_label_change_shipped False ∧ ship flags hard false ∧
    dual_linf unproven ∧ dual_recovery_path is None ∧ UNITS FCC/COKER/CDU.
    **Not** form_label_change_shipped. **Not** form flip. **Not** wire.
    **Not** VERDICT. **Not** dual L∞ under wire proof. **Not** form ship
    criteria contract (related but distinct).
    """
    honesty = _case1_form_label_second_coreq_operational_prep_honesty_fields()
    dual_linf = case1_dual_linf_proof_checklist()
    first_blocking = (
        case1_dual_honest_multi_blocker_wire_implementation_blueprint_first_blocking_coreq(
            dual_linf=dual_linf
    ...
    companion = case1_form_label_second_coreq_companion_artifacts()
    prep_steps = case1_form_label_second_coreq_prep_steps()
    form = case1_form_label_contract()
    blockers = list(DEFAULT_WIRE_BLOCKERS)
    critical = set(CASE1_CONTRACT_CRITICAL_BLOCKERS)
    blockers_still_documented = critical.issubset(set(blockers)) and len(blockers) > 0
    ...
    form_mutation_path_executed_today = bool(
        CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_EXECUTED_TODAY
    )
    prep_present = True
    form_label_second_coreq_prep_present = True
    ...
    dual_ban_ok = bool(
        ...
        and honesty["form_label_change_shipped"] is False
        and honesty["feature_flag_enabled_today"] is False
        and honesty["form_mutation_path_executed_today"] is False
        and honesty["prep_is_not_form_label_change_shipped"] is True
        and honesty["prep_is_not_form_flip"] is True
        and honesty["prep_is_not_wire"] is True
        and honesty["prep_is_not_verdict_gate"] is True
        and honesty["prep_is_not_dual_linf_under_wire_proof"] is True
        and honesty["this_prep_alone_is_not_ship_criterion"] is True
        and honesty["distinct_from_form_label_change_shipped_criteria_contract"] is True
        and honesty["order_hint_is_not_executor"] is True
        and honesty["no_auto_wire"] is True
    ...
    go_board_link_ok = bool(
        ...
        and any(
            ...
            for a in (go_board.get("file_level_prep_map") or {}).get(
                "form_label_change_shipped", []
            )
        )
    )
    companion_ok = bool(
        ...
        and companion["form_mutation_path_name"]
        == CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME
        and companion["form_mutation_path_executed_today"] is False
    )
    prep_steps_ok = bool(
        len(prep_steps) >= 5
        and all(s.get("executes_form_flip") is False for s in prep_steps)
        and all(s.get("ships") is False for s in prep_steps)
        and prep_steps[0]["step_id"] == "form_registration_present"
    )
    anti = CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY
    anti_ok = (
        "this_prep_alone" in anti
        and "form_label_criteria_alone" in anti
        and "form_registration_alone" in anti
        and "packaging_alone" in anti
        and "blueprint_alone" in anti
        and "scaffold_alone" in anti
        ...
        and "path_design_alone" in anti
        and "diagnostic_linf_alone" in anti
        and "dual_space_form_alone" in anti
    )
    prep_formalized = bool(
        prep_present
        and form_label_second_coreq_prep_present
        and operational_prep_present
        and first_blocking_ok
        and companion_ok
        and prep_steps_ok
        and anti_ok
        and CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANNOTATION == "present"
        and form_mutation_path_executed_today is False
    )
    honesty_ok = bool(
        dual_ban_ok
        and units_ok
    ...
    ok_criteria = (
        "prep formalized ∧ honesty locks ∧ prep_present=True ∧ "
        "form_label_second_coreq_prep_present=True ∧ form classic ∧ "
        "form_label_change_shipped=False ∧ form_label_ship_allowed_today=False ∧ "
        "form_mutation_path_executed_today=False ∧ "
        "first_blocking_coreq=isolation_rewrite_with_wire (form second) ∧ "
        "path/wire/bundle/isolation ship flags false ∧ dual_linf unproven ∧ "
        "dual_recovery_path=None ∧ blockers non-empty ∧ UNITS FCC/COKER/CDU — "
        "NOT form_label_change_shipped; NOT form flip; NOT wire; NOT VERDICT; "
        "NOT dual L∞ under wire proof; NOT form ship criteria met"
    )
    dual_recovery_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    form_prep_artifacts = (go_board.get("file_level_prep_map") or {}).get(
        "form_label_change_shipped", []
    )
    return {
        **honesty,
        ...
        "ok_criteria": ok_criteria,
        "prep_present": prep_present,
        "form_label_second_coreq_prep_present": form_label_second_coreq_prep_present,
        "operational_prep_present": operational_prep_present,
        "prep_annotation": CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANNOTATION,
        "first_blocking_coreq": first_blocking.get("first_blocking_coreq"),
        "first_blocking_coreq_status": first_blocking.get("first_blocking_coreq_status"),
        "first_blocking": first_blocking,
        "go_board_form_label_prep_artifacts": form_prep_artifacts,
        "companion_artifacts": companion,
        "prep_steps": prep_steps,
        "n_prep_steps": len(prep_steps),
        "anti_criteria_today": list(anti),
        "form_mutation_path_name": CASE1_FORM_LABEL_CHANGE_MUTATION_PATH_NAME,
        "form_mutation_path_executed_today": form_mutation_path_executed_today,
        "form_label_ship_criteria_present": True,
        "form_registration_present": True,
        "isolation_rewrite_shipped": isolation_rewrite_shipped,
        "isolation_tests_rewritten_with_wire": isolation_tests_rewritten_with_wire,
        "isolation_rewrite_with_wire": isolation_status,
        "isolation_rewrite_still_open": isolation_still_open,
        ...
        "tf_available": tf_available(),
        "form_label_second_coreq_operational_prep_available": True,
        "excel_packaging_twin_present": True,
        "excel_packaging_twin_deferred": False,
        "any_ship_allowed_today": False,
        "all_ship_flags_false": True,
...
def case1_form_label_second_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for ``offline_case1_form_label_second_coreq_operational_prep_report``."""
    return offline_case1_form_label_second_coreq_operational_prep_report()


def multi_unit_case1_form_label_second_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for multi-unit registry symmetry."""
    return offline_case1_form_label_second_coreq_operational_prep_report()
...
# ---------------------------------------------------------------------------
# Case-1 path *third-coreq* operational prep (order_hint[2]) — prep without ship
# Distinct from path design / path present criteria / execution scaffold.
# ---------------------------------------------------------------------------

CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_KIND = (
    "offline_case1_path_third_coreq_operational_prep"
)
CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANNOTATION = "present"
CASE1_PATH_THIRD_COREQ_ORDER_HINT_INDEX = 2
CASE1_PATH_THIRD_COREQ_ORDER_HINT_COREQ = "dual_honest_tf_aware_path_present"

CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY: tuple = (
    "this_prep_alone",
    "path_design_alone",
    "path_present_criteria_alone",
    "scaffold_alone",
...
CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS: Dict[str, Any] = {
    "companion_artifacts_are_inventory_only": True,
    "path_design_report": (
        "offline_case1_dual_honest_tf_aware_path_design_contract_report"
    ),
    "path_present_criteria_report": (
        "offline_case1_dual_honest_tf_aware_path_present_criteria_contract_report"
    ),
    "execution_scaffold_report": (
        "offline_case1_dual_honest_tf_aware_path_execution_scaffold_report"
    ),
    "feature_flag_name": CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME,
    "feature_flag_enabled_today": (
...
def case1_path_third_coreq_companion_artifacts() -> Dict[str, Any]:
    """Static companion artifact inventory (inventory only — not path ship)."""
    return {
        "companion_artifacts_are_inventory_only": True,
        "path_design_report": CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS[
            "path_design_report"
        ],
        "path_present_criteria_report": CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS[
            "path_present_criteria_report"
        ],
        "execution_scaffold_report": CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS[
            "execution_scaffold_report"
        ],
        "feature_flag_name": CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME,
        "feature_flag_enabled_today": bool(
        ...
        "optional_rehearsal_report": CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS[
            "optional_rehearsal_report"
        ],
        "optional_blueprint_report": CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS[
            "optional_blueprint_report"
        ],
        "note": (
            "Inventory of path third-coreq companion artifacts. Path design + "
            "path present criteria + execution scaffold + feature flag named "
            "not enabled + optional rehearsal/blueprint are listed only — not "
            "executed as path ship. Prep inventory ≠ path_shipped ≠ "
            "dual_honest_tf_aware_path_present ship-met."
        ),
    }


def case1_path_third_coreq_prep_steps() -> List[Dict[str, Any]]:
    """Machine-readable prep steps for path third-coreq (no path ship)."""
    dual_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    flag = CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
    return [
        {
            "step_id": "path_design_present",
            "artifact": (
                "offline_case1_dual_honest_tf_aware_path_design_contract_report"
            ),
            "status": "present",
            "executes_path_ship": False,
            "ships": False,
            "note": "Path design formalizes *what*; path_shipped still False.",
        },
        {
            "step_id": "path_present_criteria_present",
            "artifact": (
                "offline_case1_dual_honest_tf_aware_path_present_criteria_contract_report"
            ),
            "status": "present_ship_false",
            ...
            "ships": False,
            "note": (
                "Path present criteria formalize *when present-for-ship*; "
                "dual_honest_tf_aware_path_present ship-met still False; "
                "criteria_met_today False."
            ),
        },
        {
            "step_id": "execution_scaffold_present",
            "artifact": (
                "offline_case1_dual_honest_tf_aware_path_execution_scaffold_report"
            ),
            "status": "present_not_ship",
            "executes_path_ship": False,
            "ships": False,
            "note": (
                "Execution scaffold formalizes *compose pieces without ship*; "
                "scaffold inventory ≠ path ship."
            ),
        },
        {
        ...
        },
        {
            ...
            "ships": False,
            "note": (
                "prep≠ship; path_shipped false; dual_honest_tf_aware_path_present "
                "ship-met false; dual_linf unproven; dual_recovery_path=None "
                f"today; planned under wire={dual_planned} (not pure-ADMM); "
                "form classic; first_blocking still isolation."
            ),
        },
        {
            "step_id": "first_blocking_still_isolation",
            ...
            "ships": False,
            "note": (
                "order_hint_index=2 dual_honest_tf_aware_path_present is third "
                "coreq; first_blocking_coreq remains isolation_rewrite_with_wire."
            ),
        },
        {
            "step_id": "steps_complete_is_not_path_ship",
            "artifact": "anti_criteria",
            "status": "locked",
            "executes_path_ship": False,
            "ships": False,
            "note": (
                "Prep steps complete ≠ path_shipped ≠ dual_honest_tf_aware_path_present "
                "ship-met ≠ wire ≠ feature flag enable ≠ VERDICT."
            ),
        },
    ]


def _case1_path_third_coreq_operational_prep_honesty_fields() -> Dict[str, Any]:
    """Machine-readable dual-ban / prep-is-not-ship locks for path third coreq."""
    return {
        "kind": CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_KIND,
        "solver": False,
        "dual_recovery_path": None,
        "on_excel_case1_path": False,
        "on_case1_solve": False,
        ...
        "this_prep_alone_is_anti_criterion_for_path_ship": True,
        "go_board_alone_is_not_ship_criterion": True,
        "design_alone_is_not_ship_criterion": True,
        "ship_criteria_alone_is_not_ship_criterion": True,
        "blueprint_alone_is_not_ship_criterion": True,
        ...
        "no_blender_offline_affine_kernel_blocker_still_true": True,
        "case1_is_cdu_blender_package_admm_blocker_still_true": True,
        "scope": "case1_path_third_coreq_operational_prep_offline",
        "note": (
            "Offline Case-1 path third-coreq *operational prep*: machine-readable "
            "*how third-coreq prep lands without ship* for order_hint[2] "
            "dual_honest_tf_aware_path_present. prep_present=True / "
            "path_third_coreq_prep_present=True; path_shipped=False; "
            "dual_honest_tf_aware_path_present ship-met=False; "
            ...
            "path/wire/bundle/isolation/form ship flags hard false; dual_linf "
            "unproven; dual_recovery_path=None today; planned under wire="
            f"{CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED} "
            "(not pure-ADMM); first_blocking_coreq remains "
            "isolation_rewrite_with_wire (path is third, not first). Distinct "
            "from path design (*what*), path present criteria (*when "
            "present-for-ship*), and execution scaffold (*compose without ship*). "
            "Prep alone / path design alone / path present criteria alone / "
            "scaffold alone / packaging alone / blueprint alone / rehearsal "
            "alone / diagnostic L∞ ≠ path_shipped ≠ dual_honest_tf_aware_path_present "
            "ship-met ≠ wire ≠ feature flag enable ≠ VERDICT. Does not redefine "
            "ready_for_wire_discussion; does not clear DEFAULT_WIRE_BLOCKERS; "
            "does not enable Case 1 TF feature flag; isolation suite behavior "
            "unchanged. SUGGESTED_NEXT_WAVE still full multi-blocker wire "
            "*execution* long-term."
        ),
    }


def offline_case1_path_third_coreq_operational_prep_report() -> Dict[str, Any]:
    """Always-on path third-coreq operational prep (prep without path ship).

    No TF, no PuLP, no excel_pipeline, no Case 1 solve routing. Aggregate
    ``ok`` / ``contract_ok`` / ``prep_ok`` = prep formalized ∧ honesty locks ∧
    prep_present ∧ first_blocking_coreq=isolation_rewrite_with_wire ∧ form
    classic ∧ path_shipped False ∧ dual_honest_tf_aware_path_present ship-met
    False ∧ ship flags hard false ∧ dual_linf unproven ∧ dual_recovery_path
    is None ∧ UNITS FCC/COKER/CDU.
    **Not** path_shipped. **Not** dual_honest_tf_aware_path_present ship-met.
    **Not** wire. **Not** VERDICT. **Not** dual L∞ under wire proof.
    **Not** path design / present criteria / scaffold (related but distinct).
    """
    honesty = _case1_path_third_coreq_operational_prep_honesty_fields()
    dual_linf = case1_dual_linf_proof_checklist()
    first_blocking = (
        case1_dual_honest_multi_blocker_wire_implementation_blueprint_first_blocking_coreq(
            dual_linf=dual_linf
    ...
    companion = case1_path_third_coreq_companion_artifacts()
    prep_steps = case1_path_third_coreq_prep_steps()
    form = case1_form_label_contract()
    blockers = list(DEFAULT_WIRE_BLOCKERS)
    critical = set(CASE1_CONTRACT_CRITICAL_BLOCKERS)
    blockers_still_documented = critical.issubset(set(blockers)) and len(blockers) > 0
    ...
    dual_ban_ok = bool(
        ...
        and honesty["form_label_change_shipped"] is False
        and honesty["feature_flag_enabled_today"] is False
        and honesty["prep_is_not_path_shipped"] is True
        and honesty["prep_is_not_ship_met"] is True
        and honesty["prep_is_not_wire"] is True
        and honesty["prep_is_not_verdict_gate"] is True
        and honesty["prep_is_not_dual_linf_under_wire_proof"] is True
        and honesty["prep_is_not_feature_flag_enable"] is True
        and honesty["this_prep_alone_is_not_ship_criterion"] is True
        and honesty["distinct_from_path_design_contract"] is True
        and honesty["distinct_from_path_present_criteria_contract"] is True
    ...
    go_board_link_ok = bool(
        ...
        and any(
            "operational_prep" in str(a)
            or "path_third_coreq" in str(a)
            or "path_design" in str(a)
            for a in path_prep_arts
        )
    )
    companion_ok = bool(
        companion["companion_artifacts_are_inventory_only"] is True
        ...
        == CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
        and "path_design" in companion["path_design_report"]
        and "path_present_criteria" in companion["path_present_criteria_report"]
        and "execution_scaffold" in companion["execution_scaffold_report"]
    )
    prep_steps_ok = bool(
        len(prep_steps) >= 5
        and all(s.get("executes_path_ship") is False for s in prep_steps)
        and all(s.get("ships") is False for s in prep_steps)
        and prep_steps[0]["step_id"] == "path_design_present"
    )
    anti = CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY
    anti_ok = (
        "this_prep_alone" in anti
        and "path_design_alone" in anti
        and "path_present_criteria_alone" in anti
    ...
    prep_formalized = bool(
        prep_present
        and path_third_coreq_prep_present
        and operational_prep_present
        and first_blocking_ok
        and companion_ok
        and prep_steps_ok
        and anti_ok
        and CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANNOTATION == "present"
        and feature_flag_enabled_today is False
    )
    honesty_ok = bool(
        dual_ban_ok
    ...
    ok_criteria = (
        "prep formalized ∧ honesty locks ∧ prep_present=True ∧ "
        "path_third_coreq_prep_present=True ∧ form classic ∧ "
        "path_shipped=False ∧ dual_honest_tf_aware_path_present=False ∧ "
        "ship_met_allowed_today=False ∧ path_present_criteria_met_today=False ∧ "
        "feature_flag_enabled_today=False ∧ "
        "first_blocking_coreq=isolation_rewrite_with_wire (path third) ∧ "
        "path/wire/bundle/isolation/form ship flags false ∧ dual_linf unproven ∧ "
        "dual_recovery_path=None ∧ blockers non-empty ∧ UNITS FCC/COKER/CDU — "
        "NOT path_shipped; NOT dual_honest_tf_aware_path_present ship-met; "
        "NOT wire; NOT feature flag enable; NOT VERDICT; NOT dual L∞ under wire proof"
    )
    dual_recovery_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    return {
        **honesty,
        ...
        "ok_criteria": ok_criteria,
        "prep_present": prep_present,
        "path_third_coreq_prep_present": path_third_coreq_prep_present,
        "operational_prep_present": operational_prep_present,
        "prep_annotation": CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANNOTATION,
        "first_blocking_coreq": first_blocking.get("first_blocking_coreq"),
        "first_blocking_coreq_status": first_blocking.get("first_blocking_coreq_status"),
        "first_blocking": first_blocking,
        "go_board_path_prep_artifacts": path_prep_arts,
        "companion_artifacts": companion,
        "prep_steps": prep_steps,
        "n_prep_steps": len(prep_steps),
        "anti_criteria_today": list(anti),
        ...
        "tf_available": tf_available(),
        "path_third_coreq_operational_prep_available": True,
        "excel_packaging_twin_present": True,
        "excel_packaging_twin_deferred": False,
        "any_ship_allowed_today": False,
        "all_ship_flags_false": True,
...
def offline_case1_dual_honest_tf_aware_path_third_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias sticky plan name for path third-coreq operational prep."""
    return offline_case1_path_third_coreq_operational_prep_report()


def case1_path_third_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for ``offline_case1_path_third_coreq_operational_prep_report``."""
    return offline_case1_path_third_coreq_operational_prep_report()


def multi_unit_case1_path_third_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for multi-unit registry symmetry."""
    return offline_case1_path_third_coreq_operational_prep_report()
...
CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_KIND = (
    "offline_case1_wire_fifth_coreq_operational_prep"
)
CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANNOTATION = "present"
CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_INDEX = 4
CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_COREQ = "wire_shipped"

CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY: tuple = (
    "this_prep_alone",
    "wire_ship_acceptance_design_alone",
    "wire_design_alone",
    "preflight_alone",
    ...
    "ship_criteria_alone",
    "go_board_alone",
    "feature_flag_name_alone",
)

CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS: Dict[str, Any] = {
    "companion_artifacts_are_inventory_only": True,
    "wire_ship_acceptance_design_report": (
        "offline_case1_wire_ship_acceptance_design_contract_report"
    ),
    "preflight_report": "offline_wire_preflight_report",
    "default_wire_blockers": "DEFAULT_WIRE_BLOCKERS",
    "blueprint_report": (
        "offline_case1_dual_honest_multi_blocker_wire_implementation_blueprint_report"
    ),
    "dual_linf_fourth_coreq_prep_report": (
        "offline_case1_dual_linf_fourth_coreq_operational_prep_report"
    ),
    "path_third_coreq_prep_report": (
        "offline_case1_path_third_coreq_operational_prep_report"
    ),
    "form_label_second_coreq_prep_report": (
        "offline_case1_form_label_second_coreq_operational_prep_report"
    ),
    "isolation_first_blocker_prep_report": (
        "offline_case1_isolation_rewrite_first_blocker_operational_prep_report"
    ),
    "feature_flag_name": CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME,
    "feature_flag_enabled_today": (
...
def case1_wire_fifth_coreq_companion_artifacts() -> Dict[str, Any]:
    """Static companion artifact inventory (inventory only — not wire shipped)."""
    return {
        "companion_artifacts_are_inventory_only": True,
        "wire_ship_acceptance_design_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "wire_ship_acceptance_design_report"
        ],
        "preflight_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "preflight_report"
        ],
        "default_wire_blockers": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "default_wire_blockers"
        ],
        "blueprint_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "blueprint_report"
        ],
        "dual_linf_fourth_coreq_prep_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "dual_linf_fourth_coreq_prep_report"
        ],
        "path_third_coreq_prep_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "path_third_coreq_prep_report"
        ],
        "form_label_second_coreq_prep_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "form_label_second_coreq_prep_report"
        ],
        "isolation_first_blocker_prep_report": CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS[
            "isolation_first_blocker_prep_report"
        ],
        "feature_flag_name": CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME,
        "feature_flag_enabled_today": bool(
        ...
        "note": (
            "Inventory of wire fifth-coreq companion artifacts. wire-ship acceptance "
            "design + DEFAULT_WIRE_BLOCKERS/preflight + blueprint go-board wire row + "
            "prior coreq operational preps (iso/form/path/dual_linf) are listed only — "
            "not executed as wire shipped. Prep inventory ≠ wire shipped ≠ wire allow "
            "≠ dual_linf proven ≠ gate flip."
        ),
    }


def case1_wire_fifth_coreq_prep_steps() -> List[Dict[str, Any]]:
    """Machine-readable prep steps for wire fifth-coreq (no wire ship)."""
    dual_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    flag = CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
    return [
        {
            "step_id": "wire_ship_acceptance_design_present",
            "artifact": "offline_case1_wire_ship_acceptance_design_contract_report",
            "status": "present",
            "executes_wire": False,
            "ships": False,
            "allows_wire": False,
            "note": (
                "wire-ship acceptance design formalizes *when wire may ship*; "
                "wire_shipped remains False; wire_ship_allowed_today False."
            ),
        },
        {
            "step_id": "preflight_blockers_documented",
            "artifact": "DEFAULT_WIRE_BLOCKERS / offline_wire_preflight_report",
            "status": "blockers_still_true",
            "executes_wire": False,
            "ships": False,
            "allows_wire": False,
            "note": (
                "offline preflight documents *blockers still true*; does not clear "
                "DEFAULT_WIRE_BLOCKERS; not wire shipped."
            ),
        },
        {
            "step_id": "blueprint_go_board_wire_row_present",
            "artifact": "go_board order_hint_rows[4] wire_shipped",
            "status": "present_inventory",
            "executes_wire": False,
            "ships": False,
            "allows_wire": False,
            "note": (
                "Blueprint go-board wire row lists design + preflight + this prep as "
                "inventory; order_hint is not an executor; not first_blocking."
            ),
        },
        {
            "step_id": "all_prior_coreq_prep_present_as_inventory_only",
            "artifact": "iso/form/path/dual_linf operational preps",
            "status": "inventory_only",
            "executes_wire": False,
            "ships": False,
            "allows_wire": False,
            "note": (
                "Prior order_hint coreq operational preps present as inventory only — "
                "not isolation rewrite shipped, not form flip, not path ship, not "
                "dual_linf proven."
            ),
        },
        {
            ...
            "allows_wire": False,
            "note": (
                "prep≠wire shipped; wire_ship_allowed_today false; dual_linf unproven; "
                "gate open; dual_recovery_path=None today; "
                f"planned under wire={dual_planned} (not pure-ADMM); form classic; "
                "first_blocking still isolation; feature flag named not enabled "
                f"({flag})."
            ),
        ...
        },
        {
            ...
            "allows_wire": False,
            "note": (
                "order_hint_index=4 wire_shipped is fifth coreq; "
                "first_blocking_coreq remains isolation_rewrite_with_wire; "
                "is_first_blocking_coreq=False."
            ),
        },
        {
            "step_id": "steps_complete_is_not_wire_shipped",
            "artifact": "anti_criteria",
            "status": "locked",
            "executes_wire": False,
            "ships": False,
            "allows_wire": False,
            "note": (
                "Prep steps complete ≠ wire shipped ≠ wire allow ≠ dual_linf proven "
                "≠ gate flip ≠ path ship ≠ form flip ≠ feature flag enable ≠ VERDICT."
            ),
        },
    ]


def _case1_wire_fifth_coreq_operational_prep_honesty_fields() -> Dict[str, Any]:
    """Machine-readable dual-ban / prep-is-not-ship locks for wire fifth coreq."""
    return {
        "kind": CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_KIND,
        "solver": False,
        "dual_recovery_path": None,
        "on_excel_case1_path": False,
        "on_case1_solve": False,
        ...
        "prep_is_not_wire_ship_acceptance_design": True,
        "prep_is_not_preflight": True,
        "prep_is_not_blueprint": True,
        "prep_is_not_bundle_shipped": True,
        "prep_is_not_verdict_gate": True,
        "prep_is_not_dual_linf_under_wire_proof": True,
        ...
        "distinct_from_blueprint_rehearsal_scaffold": True,
        "this_prep_formalizes_how_fifth_coreq_prep_lands_without_ship": True,
        "wire_is_fifth_coreq_not_first_blocking": True,
        "order_hint_index": CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_INDEX,
        "order_hint_coreq": CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_COREQ,
        "is_first_blocking_coreq": False,
        "no_blender_offline_affine_kernel_blocker_still_true": True,
        "case1_is_cdu_blender_package_admm_blocker_still_true": True,
        "scope": "case1_wire_fifth_coreq_operational_prep_offline",
        "note": (
            "Offline Case-1 wire fifth-coreq *operational prep*: machine-readable "
            "*how fifth-coreq prep lands without ship* for order_hint[4] wire_shipped. "
            "prep_present=True / wire_fifth_coreq_prep_present=True; wire_shipped=False; "
            "wire_ship_allowed_today=False; wire_ship_criteria_met_today=False; "
            "dual_linf_under_wire=unproven; dual_linf_proof_allowed_today=False; "
            "gate_flip_allowed_today=False; online_linf_gate_under_tf_path=open; "
            "feature_flag_enabled_today=False with feature flag named "
            f"{CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME}; "
            "path/bundle/isolation/form ship flags hard false; dual_recovery_path=None "
            "today; planned under wire="
            f"{CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED} "
            "(not pure-ADMM); first_blocking_coreq remains isolation_rewrite_with_wire "
            "(wire is fifth, not first). Distinct from wire-ship acceptance design "
            "(*when may ship*), offline preflight (*blockers still true*), multi-blocker "
            "bundle design/criteria, blueprint/rehearsal/scaffold, and prior coreq "
            "operational preps (iso/form/path/dual_linf). Prep alone / design alone / "
            "preflight alone / packaging alone / dual_linf prep alone ≠ wire shipped ≠ "
            "wire allow ≠ dual_linf proven ≠ gate closed ≠ VERDICT. Does not redefine "
            "ready_for_wire_discussion; does not clear DEFAULT_WIRE_BLOCKERS; does not "
            "enable Case 1 TF feature flag; isolation suite behavior unchanged. "
            "SUGGESTED_NEXT_WAVE still full multi-blocker wire *execution* long-term."
        ),
    }


def offline_case1_wire_fifth_coreq_operational_prep_report() -> Dict[str, Any]:
    """Always-on wire fifth-coreq operational prep (prep without wire ship).

    No TF, no PuLP, no excel_pipeline, no Case 1 solve routing. Aggregate
    ``ok`` / ``contract_ok`` / ``prep_ok`` = prep formalized ∧ honesty locks ∧
    prep_present ∧ first_blocking_coreq=isolation_rewrite_with_wire ∧ form
    classic ∧ wire_shipped False ∧ wire_ship_allowed_today False ∧
    dual_linf unproven ∧ gate open ∧ ship flags hard false ∧
    dual_recovery_path is None ∧ UNITS FCC/COKER/CDU.
    **Not** wire shipped. **Not** wire allow. **Not** dual_linf proven.
    **Not** gate flip. **Not** VERDICT. **Not** wire design / preflight alone.
    """
    honesty = _case1_wire_fifth_coreq_operational_prep_honesty_fields()
    dual_linf = case1_dual_linf_proof_checklist()
    first_blocking = (
        case1_dual_honest_multi_blocker_wire_implementation_blueprint_first_blocking_coreq(
            dual_linf=dual_linf
    ...
    companion = case1_wire_fifth_coreq_companion_artifacts()
    prep_steps = case1_wire_fifth_coreq_prep_steps()
    form = case1_form_label_contract()
    blockers = list(DEFAULT_WIRE_BLOCKERS)
    critical = set(CASE1_CONTRACT_CRITICAL_BLOCKERS)
    blockers_still_documented = critical.issubset(set(blockers)) and len(blockers) > 0
    ...
    wire_criteria_met_map = case1_wire_ship_acceptance_criteria_met_today_map()
    wire_ship_allowed_today = case1_wire_ship_allowed_today(wire_criteria_met_map)
    wire_ship_criteria_met_today = all(wire_criteria_met_map.values()) if wire_criteria_met_map else False
    gate_met_map = case1_online_linf_gate_criteria_met_today_map()
    gate_flip_allowed_today = case1_online_linf_gate_flip_allowed_today(gate_met_map)
    form_label_met_map = case1_form_label_change_shipped_criteria_met_today_map()
    form_label_ship_allowed_today = case1_form_label_ship_allowed_today(
    ...
    dual_ban_ok = bool(
        ...
        and honesty["dual_linf_proof_allowed_today"] is False
        and honesty["criteria_met_today"] is False
        and honesty["wire_ship_criteria_met_today"] is False
        and honesty["prep_is_not_wire_shipped"] is True
        and honesty["prep_is_not_wire_ship_allow"] is True
        and honesty["prep_is_not_wire"] is True
        and honesty["prep_is_not_verdict_gate"] is True
        and honesty["prep_is_not_feature_flag_enable"] is True
        and honesty["this_prep_alone_is_not_wire_shipped"] is True
        and honesty["distinct_from_wire_ship_acceptance_design_contract"] is True
        and honesty["distinct_from_offline_wire_preflight"] is True
        and honesty["distinct_from_prior_coreq_operational_preps"] is True
        and honesty["order_hint_is_not_executor"] is True
        and honesty["no_auto_wire"] is True
        and honesty["is_first_blocking_coreq"] is False
        and honesty["order_hint_index"] == 4
        and honesty["wire_is_fifth_coreq_not_first_blocking"] is True
    )
    dual_linf_unproven_ok = bool(
        dual_linf["dual_linf_under_wire_status"] == "unproven"
        and dual_linf["dual_linf_under_wire_unproven_still_true"] is True
    ...
    wire_prep_arts = (go_board.get("file_level_prep_map") or {}).get(
        "wire_shipped", []
    )
    go_board_link_ok = bool(
        go_board.get("order_hint_is_not_executor") is True
        and any(
            "operational_prep" in str(a)
            or "wire_fifth_coreq" in str(a)
            or "wire_ship_acceptance" in str(a)
            or "preflight" in str(a).lower()
            for a in wire_prep_arts
        )
    )
    companion_ok = bool(
        companion["companion_artifacts_are_inventory_only"] is True
        ...
        and companion["feature_flag_name"]
        == CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
        and "wire_ship" in companion["wire_ship_acceptance_design_report"]
        and "preflight" in companion["preflight_report"]
        and "dual_linf" in companion["dual_linf_fourth_coreq_prep_report"]
    )
    prep_steps_ok = bool(
        len(prep_steps) >= 5
        and all(s.get("executes_wire") is False for s in prep_steps)
        and all(s.get("ships") is False for s in prep_steps)
        and all(s.get("allows_wire") is False for s in prep_steps)
        and prep_steps[0]["step_id"] == "wire_ship_acceptance_design_present"
    )
    anti = CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY
    anti_ok = (
        "this_prep_alone" in anti
        and "wire_ship_acceptance_design_alone" in anti
        and "preflight_alone" in anti
        and "blueprint_alone" in anti
        and "rehearsal_alone" in anti
        and "scaffold_alone" in anti
        and "packaging_alone" in anti
        and "dual_linf_fourth_coreq_prep_alone" in anti
        and "path_third_coreq_prep_alone" in anti
        and "form_label_second_coreq_prep_alone" in anti
        and "isolation_first_blocker_prep_alone" in anti
        and "probe_linf" in anti
    ...
    prep_formalized = bool(
        prep_present
        and wire_fifth_coreq_prep_present
        and operational_prep_present
        and first_blocking_ok
        and companion_ok
        and prep_steps_ok
        and anti_ok
        and CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANNOTATION == "present"
        and feature_flag_enabled_today is False
        and wire_shipped is False
        and wire_ship_allowed_today is False
    )
    ...
    ok_criteria = (
        "prep formalized ∧ honesty locks ∧ prep_present=True ∧ "
        "wire_fifth_coreq_prep_present=True ∧ form classic ∧ "
        "wire_shipped=False ∧ wire_ship_allowed_today=False ∧ "
        "wire_ship_criteria_met_today=False ∧ dual_linf_under_wire=unproven ∧ "
        "dual_linf_proof_allowed_today=False ∧ gate open ∧ "
        "gate_flip_allowed_today=False ∧ feature_flag_enabled_today=False ∧ "
        "first_blocking_coreq=isolation_rewrite_with_wire (wire fifth) ∧ "
        "path/bundle/isolation/form ship flags false ∧ "
        "dual_recovery_path=None ∧ blockers non-empty ∧ UNITS FCC/COKER/CDU — "
        "NOT wire shipped; NOT wire allow; NOT dual_linf proven; NOT gate flip; "
        "NOT feature flag enable; NOT VERDICT; NOT design alone; NOT preflight alone"
    )
    dual_recovery_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    return {
        **honesty,
        ...
        "ok_criteria": ok_criteria,
        "prep_present": prep_present,
        "wire_fifth_coreq_prep_present": wire_fifth_coreq_prep_present,
        "operational_prep_present": operational_prep_present,
        "prep_annotation": CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANNOTATION,
        "first_blocking_coreq": first_blocking.get("first_blocking_coreq"),
        "first_blocking_coreq_status": first_blocking.get("first_blocking_coreq_status"),
        "first_blocking": first_blocking,
        "go_board_wire_prep_artifacts": wire_prep_arts,
        "companion_artifacts": companion,
        "prep_steps": prep_steps,
        "n_prep_steps": len(prep_steps),
        "anti_criteria_today": list(anti),
        "wire_ship_acceptance_design_present": True,
        "preflight_blockers_documented": True,
        "prior_coreq_preps_present_as_inventory_only": True,
        "isolation_rewrite_shipped": isolation_rewrite_shipped,
        "isolation_tests_rewritten_with_wire": isolation_tests_rewritten_with_wire,
        "isolation_rewrite_with_wire": isolation_status,
        "isolation_rewrite_still_open": isolation_still_open,
        ...
        "tf_available": tf_available(),
        "wire_fifth_coreq_operational_prep_available": True,
        "excel_packaging_twin_present": True,
        "excel_packaging_twin_deferred": False,
        "any_ship_allowed_today": False,
        "all_ship_flags_false": True,
...
def offline_case1_wire_shipped_fifth_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias sticky plan name for wire fifth-coreq operational prep."""
    return offline_case1_wire_fifth_coreq_operational_prep_report()


def case1_wire_fifth_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for ``offline_case1_wire_fifth_coreq_operational_prep_report``."""
    return offline_case1_wire_fifth_coreq_operational_prep_report()


def multi_unit_case1_wire_fifth_coreq_operational_prep_report() -> Dict[str, Any]:
    """Alias for multi-unit registry symmetry."""
    return offline_case1_wire_fifth_coreq_operational_prep_report()
...
# ---------------------------------------------------------------------------
# Offline Case-1 isolation rewrite first-blocker *execution scaffold* (goal 5+3)
# ---------------------------------------------------------------------------
# Dry-run mutation inventory / offline how-without-ship for first_blocking_coreq
# =isolation_rewrite_with_wire. scaffold_present=True; isolation_rewrite_shipped
# False; isolation_ship_allowed_today False; suite NOT rewritten this cycle.
# Distinct from: isolation design (*what*), ship-met criteria (*when*),
# operational prep (*how prep lands*), path execution scaffold (*path how*),
# wire fifth prep. Does NOT ship rewrite/wire/path/form; feature flag reserved
# False; dual_recovery_path=None; no excel_pipeline/pulp/tensorflow on hot path.

CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_KIND = (
    "offline_case1_isolation_rewrite_first_blocker_execution_scaffold"
)
CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANNOTATION = "present"
CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_INDEX = 0
CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_COREQ = (
    "isolation_rewrite_with_wire"
)

CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_CURRENT_TESTS: tuple = (
...
CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_TEST_THEMES: Dict[str, str] = {
    "test_excel_pipeline_source_has_no_tf_imports": "excel_ast_no_tf",
    "test_excel_pipeline_source_text_no_tf_import_lines": "excel_ast_no_tf",
    "test_models_package_init_does_not_import_tf_linear": "package_init_no_tf",
    "test_import_excel_pipeline_without_tensorflow_in_sys_modules": "import_excel_without_tf",
    "test_tf_linear_blocks_importable_without_tensorflow": "tlb_offline_import",
    "test_tf_available_does_not_raise_when_missing": "tf_available_safe",
    "test_coker_kernel_symbols_exist_without_tf_and_stay_offline": "coker_offline",
    "test_cdu_kernel_symbols_exist_without_tf_and_stay_offline": "cdu_offline",
}

CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANTI_CRITERIA_TODAY: tuple = (
    "probe_linf",
    "bridge_linf",
    "warmstart_linf",
    "pooling_linf",
    ...
    "isolation_design_alone",
    "isolation_ship_criteria_alone",
    "isolation_operational_prep_alone",
    "go_board_alone",
    "blueprint_alone",
    "rehearsal_alone",
    "form_label_criteria_alone",
...
def case1_isolation_rewrite_execution_scaffold_mutation_inventory() -> Dict[str, Any]:
    """Named-test dry-run mutation inventory (inventory only — not suite rewrite)."""
    flag = CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
    tests: List[Dict[str, Any]] = []
    for name in CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_CURRENT_TESTS:
        theme = CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_TEST_THEMES.get(
            name, "isolation_theme"
        )
        planned = (
            "classic path still import-isolated; optional wire path only if "
            f"feature_flag {flag} true (false today); rewrite-not-delete; no silent suite deletion"
        )
        tests.append(
            {
                "test_name": name,
                "theme": theme,
                "must_remain_after_rewrite": True,
                "planned_post_wire_assertion": planned,
                "mutation_status_today": "not_applied",
                "executes_rewrite": False,
            }
        )
    return {
        ...
        "rewrite_not_delete": True,
        "isolation_tests_rewritten_with_wire": False,
        "inventory_is_not_rewrite_shipped": True,
        "inventory_is_not_isolation_ship_allow": True,
        "mutation_status_today": "not_applied",
        "n_current_tests": len(tests),
        "current_tests": list(CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_CURRENT_TESTS),
        "tests": tests,
        "planned_post_wire_assertion_shape": (
            "classic path still import-isolated; optional wire path gated by "
            f"{flag} reserved false today; rewrite-not-delete; no silent suite deletion"
        ),
        "feature_flag_name": flag,
        "feature_flag_enabled_today": False,
        "note": (
            "Dry-run mutation inventory for isolation suite rewrite-with-wire. "
            "Not applied this cycle; suite behavior unchanged."
        ),
    }


def case1_isolation_rewrite_first_blocker_scaffold_steps() -> List[Dict[str, Any]]:
    """Machine-readable scaffold steps (each executes_rewrite=False)."""
    dual_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    flag = CASE1_DUAL_HONEST_TF_AWARE_PATH_FEATURE_FLAG_NAME
    return [
        {
            "step_id": "suite_path_documented",
            "artifact": CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_SUITE_PATH,
            "status": "documented",
            "executes_rewrite": False,
            "note": "Suite path documented; do not rewrite suite this cycle.",
        },
        {
            "step_id": "rewrite_not_delete_locked",
            "artifact": "rewrite_not_delete",
            "status": "locked",
            "executes_rewrite": False,
            "note": "Rewrite-not-delete locked; suite_delete_forbidden.",
        },
        {
            "step_id": "current_tests_inventoried",
            "artifact": "CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_CURRENT_TESTS",
            "status": "inventoried",
            "executes_rewrite": False,
            "note": "Eight current isolation tests inventoried by name.",
        },
        {
            "step_id": "planned_post_wire_assertions_named",
            "artifact": "planned_post_wire_assertion_shape",
            "status": "named_not_applied",
            "executes_rewrite": False,
            "note": "Planned post-wire assertion shapes named; mutation_status=not_applied.",
        },
        {
            "step_id": "feature_flag_reserved_named",
            "artifact": flag,
            "status": "reserved_false",
            "executes_rewrite": False,
            "note": f"Feature flag {flag} reserved False today.",
        },
        {
            "step_id": "dual_ban_locks",
            "artifact": "scaffold_dual_ban_tokens",
            "status": "locked",
            "executes_rewrite": False,
            "note": (
                "scaffold≠ship; dual_linf unproven; dual_recovery_path=None today; "
                f"planned under wire={dual_planned} (not pure-ADMM)."
            ),
        },
        {
            "step_id": "first_blocking_still_isolation",
            "artifact": "isolation_rewrite_with_wire",
            "status": "open",
            "executes_rewrite": False,
            "note": "first_blocking_coreq remains isolation_rewrite_with_wire; order_hint_index=0.",
        },
        {
            "step_id": "scaffold_complete_is_not_rewrite_shipped",
            "artifact": "anti_criteria",
            "status": "locked",
            "executes_rewrite": False,
            "note": (
                "Scaffold complete ≠ isolation_rewrite_shipped ≠ isolation_ship_allowed "
                "≠ wire ≠ dual_linf proven ≠ gate flip ≠ VERDICT."
            ),
        },
    ]


def _case1_isolation_rewrite_first_blocker_execution_scaffold_honesty_fields() -> Dict[str, Any]:
    """Machine-readable dual-ban / scaffold-is-not-ship locks."""
    return {
        "kind": CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_KIND,
        "solver": False,
        "dual_recovery_path": None,
        "on_excel_case1_path": False,
        "on_case1_solve": False,
        ...
        "this_scaffold_alone_is_not_multi_blocker_ship": True,
        "this_execution_scaffold_alone_is_not_ship_criterion": True,
        "operational_prep_alone_is_not_ship_criterion": True,
        "design_alone_is_not_ship_criterion": True,
        "ship_met_criteria_alone_is_not_ship_criterion": True,
        "path_execution_scaffold_alone_is_not_isolation_rewrite_shipped": True,
        "wire_fifth_prep_alone_is_not_ship_criterion": True,
        "packaging_alone_is_not_ship_criterion": True,
        "order_hint_is_not_executor": True,
        "no_auto_wire": True,
        "does_not_rewrite_isolation_suite": True,
        ...
        "no_blender_offline_affine_kernel_blocker_still_true": True,
        "case1_is_cdu_blender_package_admm_blocker_still_true": True,
        "scope": "case1_isolation_rewrite_first_blocker_execution_scaffold_offline",
        "note": (
            "Offline Case-1 isolation first-blocker *execution scaffold*: dry-run "
            "mutation inventory / offline how-without-ship for "
            "first_blocking_coreq=isolation_rewrite_with_wire. "
            ...
            "path/wire/bundle/form ship flags hard false; dual_linf unproven; "
            "dual_recovery_path=None today; planned under wire="
            f"{CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED} (not pure-ADMM); "
            f"suite path={CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_SUITE_PATH}; rewrite-not-delete; "
            "inventory only. Scaffold alone / design alone / ship-met alone / operational prep "
            "alone / path scaffold alone / wire fifth prep alone / packaging alone ≠ isolation "
            "rewrite shipped ≠ isolation allow ≠ wire ≠ VERDICT ≠ dual L∞ under wire proof. "
            "Distinct from iso design / ship-met / operational prep / path execution scaffold / "
            "wire fifth prep. Does not redefine ready_for_wire_discussion; does not clear "
            "DEFAULT_WIRE_BLOCKERS; does not enable Case 1 TF feature flag; isolation suite "
            "behavior unchanged this cycle. SUGGESTED_NEXT_WAVE still full multi-blocker wire "
            "*execution* long-term."
        ),
    }


def offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report() -> Dict[str, Any]:
    """Always-on isolation first-blocker rewrite *execution scaffold* (scaffold without ship).

    No TF, no PuLP, no excel_pipeline, no Case 1 solve routing. Aggregate
    ``ok`` / ``contract_ok`` / ``scaffold_ok`` = scaffold formalized ∧ honesty locks ∧
    scaffold_present ∧ first_blocking_coreq=isolation_rewrite_with_wire ∧ ship flags
    hard false ∧ dual_linf unproven ∧ dual_recovery_path is None ∧ UNITS
    FCC/COKER/CDU. **Not** isolation rewrite shipped. **Not** isolation ship allow.
    **Not** wire. **Not** form flip. **Not** VERDICT. **Not** dual L∞ under wire proof.
    """
    honesty = _case1_isolation_rewrite_first_blocker_execution_scaffold_honesty_fields()
    dual_linf = case1_dual_linf_proof_checklist()
    first_blocking = (
        case1_dual_honest_multi_blocker_wire_implementation_blueprint_first_blocking_coreq(
            dual_linf=dual_linf
    ...
    inventory = case1_isolation_rewrite_execution_scaffold_mutation_inventory()
    scaffold_steps = case1_isolation_rewrite_first_blocker_scaffold_steps()
    form = case1_form_label_contract()
    blockers = list(DEFAULT_WIRE_BLOCKERS)
    critical = set(CASE1_CONTRACT_CRITICAL_BLOCKERS)
    blockers_still_documented = critical.issubset(set(blockers)) and len(blockers) > 0
    ...
    dual_ban_ok = bool(
        ...
        and honesty["feature_flag_enabled_today"] is False
        and honesty["scaffold_is_not_isolation_rewrite_shipped"] is True
        and honesty["scaffold_is_not_isolation_ship_allow"] is True
        and honesty["scaffold_is_not_wire"] is True
        and honesty["scaffold_is_not_verdict_gate"] is True
        and honesty["scaffold_is_not_dual_linf_under_wire_proof"] is True
        and honesty["this_scaffold_alone_is_not_ship_criterion"] is True
    ...
    order_hint_index = (
        CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_INDEX
    )
    inventory_ok = bool(
        inventory["suite_path"] == CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_SUITE_PATH
        and inventory["suite_delete_forbidden"] is True
        and inventory["rewrite_not_delete"] is True
        and inventory["isolation_tests_rewritten_with_wire"] is False
        and inventory["n_current_tests"] == 8
        and len(inventory["current_tests"]) == 8
        and all(t.get("executes_rewrite") is False for t in inventory["tests"])
        and all(t.get("mutation_status_today") == "not_applied" for t in inventory["tests"])
        and inventory["feature_flag_enabled_today"] is False
    )
    scaffold_steps_ok = bool(
        len(scaffold_steps) >= 8
        and all(s.get("executes_rewrite") is False for s in scaffold_steps)
        and scaffold_steps[0]["step_id"] == "suite_path_documented"
        and any(s["step_id"] == "scaffold_complete_is_not_rewrite_shipped" for s in scaffold_steps)
    )
    anti = CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANTI_CRITERIA_TODAY
    anti_ok = (
        "this_scaffold_alone" in anti
        and "this_execution_scaffold_alone" in anti
        and "operational_prep_alone" in anti
        and "path_execution_scaffold_alone" in anti
        and "design_alone" in anti
        and "ship_met_criteria_alone" in anti
        and "wire_fifth_prep_alone" in anti
        and "packaging_alone" in anti
    )
    ...
    scaffold_formalized = bool(
        scaffold_present
        and execution_scaffold_present
        and isolation_rewrite_scaffold_present
        and first_blocking_ok
        and inventory_ok
        and scaffold_steps_ok
        and anti_ok
        and CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANNOTATION
        == "present"
    )
    honesty_ok = bool(
        dual_ban_ok
    ...
    ok_criteria = (
        "scaffold formalized ∧ honesty locks ∧ scaffold_present=True ∧ "
        "execution_scaffold_present=True ∧ isolation_rewrite_scaffold_present=True ∧ "
        ...
        "path/wire/bundle/form ship flags false ∧ dual_linf unproven ∧ "
        "dual_recovery_path=None ∧ blockers non-empty ∧ UNITS FCC/COKER/CDU — "
        "NOT isolation rewrite shipped; NOT isolation ship allow; NOT wire; "
        "NOT form flip; NOT VERDICT; NOT dual L∞ under wire proof"
    )
    dual_recovery_planned = CASE1_DUAL_HONEST_TF_AWARE_PATH_DUAL_RECOVERY_PLANNED
    go_board_arts = (go_board.get("file_level_prep_map") or {}).get(
        "isolation_rewrite_with_wire", []
    )
    return {
        **honesty,
        ...
        "scaffold_steps_ok": scaffold_steps_ok,
        "scaffold_formalized": scaffold_formalized,
        "ok_criteria": ok_criteria,
        "scaffold_present": scaffold_present,
        "execution_scaffold_present": execution_scaffold_present,
        "isolation_rewrite_scaffold_present": isolation_rewrite_scaffold_present,
        "scaffold_annotation": (
            CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANNOTATION
        ),
        "first_blocking_coreq": first_blocking.get("first_blocking_coreq"),
        "first_blocking_coreq_status": first_blocking.get("first_blocking_coreq_status"),
        "is_first_blocking_coreq": is_first_blocking_coreq,
        "order_hint_index": order_hint_index,
        "order_hint_coreq": (
            CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_COREQ
        ),
        "first_blocking": first_blocking,
        "go_board_isolation_prep_artifacts": go_board_arts,
        "mutation_inventory": inventory,
        "scaffold_steps": scaffold_steps,
        "n_scaffold_steps": len(scaffold_steps),
        "anti_criteria_today": list(anti),
        "suite_path": CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_SUITE_PATH,
        "rewrite_not_delete": True,
        "isolation_rewrite_design_present": True,
        "isolation_ship_criteria_present": True,
        "isolation_operational_prep_present": True,
        "path_execution_scaffold_present": True,
        ...
        "tf_available": tf_available(),
        "isolation_rewrite_first_blocker_execution_scaffold_available": True,
        "excel_packaging_twin_present": True,
        "excel_packaging_twin_deferred": False,
        "any_ship_allowed_today": False,
        "all_ship_flags_false": True,
...
def offline_case1_isolation_rewrite_execution_scaffold_report() -> Dict[str, Any]:
    """Sticky short alias for isolation rewrite first-blocker execution scaffold."""
    return offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report()


def case1_isolation_rewrite_first_blocker_execution_scaffold_report() -> Dict[str, Any]:
    """Alias for ``offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report``."""
    return offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report()


def multi_unit_case1_isolation_rewrite_first_blocker_execution_scaffold_report() -> Dict[str, Any]:
    """Alias for multi-unit registry symmetry."""
    return offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report()
...
__all__ = [
    ...
    "CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_KIND",
    "CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANNOTATION",
    "CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_INDEX",
    "CASE1_FORM_LABEL_SECOND_COREQ_ORDER_HINT_COREQ",
    "CASE1_FORM_LABEL_SECOND_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY",
    "CASE1_FORM_LABEL_SECOND_COREQ_COMPANION_ARTIFACTS",
    "case1_form_label_second_coreq_companion_artifacts",
    "case1_form_label_second_coreq_prep_steps",
    "offline_case1_form_label_second_coreq_operational_prep_report",
    "case1_form_label_second_coreq_operational_prep_report",
    "multi_unit_case1_form_label_second_coreq_operational_prep_report",
    "CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_KIND",
    "CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANNOTATION",
    "CASE1_PATH_THIRD_COREQ_ORDER_HINT_INDEX",
    "CASE1_PATH_THIRD_COREQ_ORDER_HINT_COREQ",
    "CASE1_PATH_THIRD_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY",
    "CASE1_PATH_THIRD_COREQ_COMPANION_ARTIFACTS",
    "case1_path_third_coreq_companion_artifacts",
    "case1_path_third_coreq_prep_steps",
    "offline_case1_path_third_coreq_operational_prep_report",
    ...
    "CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_KIND",
    "CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANNOTATION",
    "CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_INDEX",
    "CASE1_WIRE_FIFTH_COREQ_ORDER_HINT_COREQ",
    "CASE1_WIRE_FIFTH_COREQ_OPERATIONAL_PREP_ANTI_CRITERIA_TODAY",
    "CASE1_WIRE_FIFTH_COREQ_COMPANION_ARTIFACTS",
    "case1_wire_fifth_coreq_companion_artifacts",
    "case1_wire_fifth_coreq_prep_steps",
    "offline_case1_wire_fifth_coreq_operational_prep_report",
    "offline_case1_wire_shipped_fifth_coreq_operational_prep_report",
    "case1_wire_fifth_coreq_operational_prep_report",
    "multi_unit_case1_wire_fifth_coreq_operational_prep_report",
    "CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_KIND",
    "CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANNOTATION",
    "CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_INDEX",
    "CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ORDER_HINT_COREQ",
    "CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_CURRENT_TESTS",
    "CASE1_ISOLATION_REWRITE_EXECUTION_SCAFFOLD_TEST_THEMES",
    "CASE1_ISOLATION_REWRITE_FIRST_BLOCKER_EXECUTION_SCAFFOLD_ANTI_CRITERIA_TODAY",
    "case1_isolation_rewrite_execution_scaffold_mutation_inventory",
    "case1_isolation_rewrite_first_blocker_scaffold_steps",
    "offline_case1_isolation_rewrite_first_blocker_execution_scaffold_report",
    "offline_case1_isolation_rewrite_execution_scaffold_report",
    "case1_isolation_rewrite_first_blocker_execution_scaffold_report",
    "multi_unit_case1_isolation_rewrite_first_blocker_execution_scaffold_report",
